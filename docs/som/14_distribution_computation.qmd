...
### Algorithm 23: CPH PDF via Uniformization
...
|-----------|------|----------|-------|
| Algorithm 22 | `src/c/phasic.c` | `ptd_dph_probability_distribution_step` | L7498--L7549 |
| Algorithm 23 (create) | `src/c/phasic.c` | `ptd_probability_distribution_context_create` | L7551--L7647 |
| Algorithm 23 (step) | `src/c/phasic.c` | `ptd_probability_distribution_step` | L7661--L7674 |
