...
|-----------|------|----------|-------|
| @alg-09-expression-evaluation | `src/c/phasic_symbolic.c` | `ptd_expr_evaluate_iterative` | Iterative evaluation |
...
- **Recursive vs. iterative evaluation.** Both `ptd_expr_evaluate` (recursive) and `ptd_expr_evaluate_iterative` (iterative, matching @alg-09-expression-evaluation) exist. The iterative version is preferred for deep trees. The pseudocode presents only the iterative version.
