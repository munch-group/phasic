...
|-----------|------|----------|-------|
| Algorithm 33 (entry) | `src/phasic/method_of_moments.py` | `method_of_moments` | L205--L590 |
...
| $d_{\text{free}}$ | Number of free parameters | Algorithm 33 |
