...
| B | Formula-mode exact gradient | **plan-review** (v1 under two-refuter review; completeness refuter: BROKEN-salvageable — theta-dim decoupling contract (tape n_theta vs param_length, probe-confirmed raise) + C decline-set field error + gate-ladder gaps; v2 pending the math refuter) | b3/batchB-formula (worktree ../phasic-batchB, built) | b3-batchB-plan.md v1 |
