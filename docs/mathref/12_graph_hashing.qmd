...
### Algorithm 20: Graph Content Hash
...
|-----------|------|----------|-------|
| Algorithm 20 (vertex hash) | `src/c/phasic_hash.c` | `hash_vertex_structure` | L169--L214 |
| Algorithm 20 (graph hash) | `src/c/phasic_hash.c` | `ptd_graph_content_hash` | L216--L272 |
