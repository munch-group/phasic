...
| [discretize](#phasic.Graph.discretize) | Discretizes graph inplace and returns reward matrix for added auxiliary states. |
...
<code>[**rate**]{.parameter-name} [:]{.parameter-annotation-sep} [[float](`float`) \| [Callable](`collections.abc.Callable`)]{.parameter-annotation}</code>
...
<code>[]{.parameter-name} [:]{.parameter-annotation-sep} [[NDArray](`numpy.typing.NDArray`)\[[np](`numpy`).[int64](`numpy.int64`)\]]{.parameter-annotation}</code>
