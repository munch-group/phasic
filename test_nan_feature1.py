"""Test feature 1 with NaN for other features"""
import phasic
import numpy as np
...
print("Testing Feature 1 with NaN masking")
print("=" * 70)
...
# Generate observations for feature 1 only
np.random.seed(42)
...
print("\n" + "=" * 70)
print("Comparison:")
print("  Feature 0 result: 7.51 ± 0.65 (24.9% error)")
print(f"  Feature 1 result: {final_theta[0]:.2f} ± {final_std[0]:.2f} ({error_pct:.1f}% error)")
print("=" * 70)
