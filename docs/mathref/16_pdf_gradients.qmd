...
|-----------|------|----------|-------|
| Algorithm 26 (Phase 1) | `src/c/phasic.c` | `ptd_graph_pdf_with_gradient` | L7977--L8054 |
| Algorithm 26 (Phases 2--3) | `src/c/phasic.c` | `compute_pmf_with_gradient` | L7721--L7962 |
| Algorithm 26 (Phase 4) | `src/c/phasic.c` | `ptd_graph_pdf_with_gradient` | L8086--L8101 |
...
| $K$ | Maximum Poisson steps (truncation) | Algorithm 26 |
...
| $v_{\max}$ | Vertex achieving maximum exit rate | Algorithm 26 |
