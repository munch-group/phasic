"""Test coalescent with discrete=True (it's a coalescent, not continuous!)"""
...
print(f"Sample values: {observed_data[:5, 0]}")  # Show first few values

print("\nRunning SVGD with discrete=True...")

params = dict(
    observed_data=observed_data,
    discrete=True,  # KEY: coalescent is discrete!
    bandwidth='median',
    theta_dim=1,
    n_particles=8,
    n_iterations=5,
