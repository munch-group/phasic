...
<code>[**rate**]{.parameter-name} [:]{.parameter-annotation-sep} []{.parameter-annotation}</code>
...
<code>[]{.parameter-name} [:]{.parameter-annotation-sep} [[DistributionContext](`DistributionContext`)]{.parameter-annotation}</code>
...
<code>[**data**]{.parameter-name} [:]{.parameter-annotation-sep} [[Dict](`typing.Dict`)\[[str](`str`), [Any](`typing.Any`)\]]{.parameter-annotation}</code>
...
<code>[**rewards**]{.parameter-name} [:]{.parameter-annotation-sep} [[array_like](`array_like`)]{.parameter-annotation} [ = ]{.parameter-default-sep} [None]{.parameter-default}</code>
...
<code>[**optimizer**]{.parameter-name} [:]{.parameter-annotation-sep} [[Optimizer](`Optimizer`)]{.parameter-annotation} [ = ]{.parameter-default-sep} [None]{.parameter-default}</code>
...
<code>[**bandwidth**]{.parameter-name} [:]{.parameter-annotation-sep} [str, float, or array_like]{.parameter-annotation} [ = ]{.parameter-default-sep} [\'median_per_dim\']{.parameter-default}</code>

:   Kernel bandwidth selection method: - 'median_per_dim': Per-dimension median heuristic (default). Uses a   separate bandwidth per parameter dimension for an anisotropic kernel. - 'median': Scalar median heuristic (isotropic kernel) - float: Fixed scalar bandwidth value - array_like: Fixed per-dimension bandwidth vector
