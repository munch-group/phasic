"""Test log-likelihood with actual data from multivar_test.py"""
import phasic
import numpy as np
...
print("Generating data exactly as multivar_test.py...")
...
print(f"Data range: [{observed_data.min():.3f}, {observed_data.max():.3f}]")
...
print("\nTesting log-likelihoods (using FIRST 100 observations only for speed)...")
test_data = observed_data[:100, :]  # Use subset
test_thetas = [1.0, 5.0, 10.0, 20.0, 50.0, 100.0, 500.0, 700.0, 1000.0]
