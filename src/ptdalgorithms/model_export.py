...
def generate_warmup_script(
    ...
    Examples
    --------
    >>> from ptdalgorithms.model_export import generate_warmup_script
    >>>
    >>> model_code = '''
...
try:
    ...
    print("Install with: pip install ptdalgorithms[jax]")
    sys.exit(1)
...
def export_model_package(
    ...
    Examples
    --------
    >>> from ptdalgorithms import CompilationConfig
    >>> from ptdalgorithms.model_export import export_model_package
    >>>
