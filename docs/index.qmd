...
<i class="bi bi-eye"></i> **Symbolic Gauss Elimination**: <br>Directed acyclic graphs produced by symbolic Gaussian elimination, allow extremely fast reparametrization and recomputation.

:::

::: {.g-col-12 .g-col-md-4}

<i class="bi bi-question-circle"></i> **JAX integration**: <br>Automatic differentiation for gradient-based inference methods including builtin SVGD (Stein Variational Gradient Descent).

 Fit phase-type models to observed data with modern Bayesian inference techniques. 
