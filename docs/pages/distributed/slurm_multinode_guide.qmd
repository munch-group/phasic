---
title: Multi-Node SLURM Guide for Distributed SVGD
---
...
# Or create custom YAML in docs/examples/slurm_configs/
```
...
Create YAML configs in `docs/examples/slurm_configs/`:
