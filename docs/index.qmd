...
<i class="bi bi-infinity"></i> **Moments**: <br>Computes any number of  exact moments (mean, variance, skew, etc.) as well as cross-moments (covariance).

:::

::: {.g-col-12 .g-col-md-4}

<i class="bi bi-graph-down"></i> **Distributions**: <br> Computes exact PMF and PDF with arbitrary precision.
...
<i class="bi bi-arrow-bar-up"></i> **Robust**: <br>Uses multiple-precision floating-point computation when needed.
...
<i class="bi bi-bounding-box"></i> **Joint probabilities**: <br>Blah blah blah blah blah blah blah blah blah blah blah blah blah blah blah.
...
<i class="bi bi-arrow-bar-up""></i> **Distributed symbolic elimination**: <br>Computes the Gaussian elimination as symbolic graph operations.

:::

::: {.g-col-12 .g-col-md-4}

<i class="bi bi-bounding-box"></i> **Distributed model cache**: symbolic elimination traces are cached for reuse and community sharing with torrent P2P<br>.
