...
### Algorithm 4: Kahan Compensated Summation
...
### Algorithm 5: Log-Space Weight Evaluation
...
|-----------|------|----------|-------|
| Algorithm 4 | `src/c/phasic.c` | Kahan struct and macros | Used in `ptd_expected_sojourn_time_subset`, `compute_pmf_with_gradient` |
| Algorithm 5 | `src/c/phasic.c` | `ptd_graph_update_weights` (with `use_log=true`) | Log-space branch of weight update |
