...
### Algorithm 14: GenerateStateSpace
...
|-----------|------|----------|-------|
| Algorithm 14 (FindOrCreateVertex) | `src/c/phasic.c` | `ptd_find_or_create_vertex` | L7339-L7353 |
| Algorithm 14 (AVL operations) | `src/c/phasic.c` | `ptd_avl_tree_find_or_insert`, `ptd_avl_tree_find` | AVL tree implementation |
| Algorithm 14 (BFS driver) | `src/phasic/__init__.py` | `Graph.__init__` with `callback` | Python-level BFS loop |
