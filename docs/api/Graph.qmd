...
| [plot_scc_decomposition](#phasic.Graph.plot_scc_decomposition) | Visualise the SCC decomposition of this graph as a |
...
### plot_scc_decomposition { #phasic.Graph.plot_scc_decomposition }

```python
phasic.Graph.plot_scc_decomposition(
    figsize=(10.0, 6.0),
    cmap='viridis',
    show_indices=True,
    annotate_sizes=True,
...
<code>[**title**]{.parameter-name} [:]{.parameter-annotation-sep} [[str](`str`) or None]{.parameter-annotation} [ = ]{.parameter-default-sep} [None]{.parameter-default}</code>

:   Plot title. Defaults to a one-line summary of the decomposition (number of SCCs, levels, widest row).
