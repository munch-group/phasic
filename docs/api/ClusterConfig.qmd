# ClusterConfig { #ptdalgorithms.ClusterConfig }

```python
ptdalgorithms.ClusterConfig(
    name='default',
    nodes=1,
    cpus_per_node=8,
    memory_per_cpu='4G',
...
| Name | Description |
| --- | --- |
| [to_dict](#ptdalgorithms.ClusterConfig.to_dict) | Convert to dictionary. |
| [to_yaml](#ptdalgorithms.ClusterConfig.to_yaml) | Save configuration to YAML file. |

### to_dict { #ptdalgorithms.ClusterConfig.to_dict }

```python
ptdalgorithms.ClusterConfig.to_dict()
```

Convert to dictionary.

### to_yaml { #ptdalgorithms.ClusterConfig.to_yaml }

```python
ptdalgorithms.ClusterConfig.to_yaml(filepath)
```
