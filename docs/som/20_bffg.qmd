...
|-----------|------|----------|-------|
| Algorithm 32 (entry, backward compat) | `src/phasic/bffg.py` | `bffg_log_prob` / `log_prob_fn` | L570--L612 |
| Algorithm 32 (JIT model) | `src/phasic/bffg.py` | `model` | L396--L427 |
| Algorithm 32 (JIT correction) | `src/phasic/bffg.py` | `likelihood_correction_jit` | L546--L563 |
| Algorithm 32 (non-JIT correction) | `src/phasic/bffg.py` | `likelihood_correction` | L431--L456 |
...
| $L$ | Number of loci (observations) | Algorithm 32 |
