"""
Configuration system for ptdalgorithms.
...
class PTDAlgorithmsConfig:
    """
    Global configuration for ptdalgorithms behavior.
...
def configure(**kwargs) -> None:
    """
    Configure ptdalgorithms globally.
...
def get_config() -> PTDAlgorithmsConfig:
    ...
    if _global_config is None:
        ...
        _global_config = PTDAlgorithmsConfig()
        _global_config.validate()
