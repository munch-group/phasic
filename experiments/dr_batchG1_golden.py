"""Batch G.1 golden gate -- cross-install bitwise identity of the
no-kwarg default svgd-built epoch model gradient (plan v2 I3 test 7;
...
model -- its RNG never enters the compared value.
  ...
  dump  <npz>  -- run under the PRE-G.1 install (main checkout).
...
fit = jpg.svgd(obs, epoch_starts=[0.0, 0.5], n_iterations=1, n_particles=4)
