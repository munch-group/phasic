"""Test coalescent with correct parameters (regularization=0 OR nr_moments>0)"""
...
print("\nRunning SVGD with regularization=0...")
...
params = dict(
    ...
    verbose=True,
    rewards=rewards,
    regularization=0,  # KEY: No regularization (or set nr_moments=2+)
    nr_moments=0,
)
