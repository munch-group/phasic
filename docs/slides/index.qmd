...
$$
\mathbb{E}[\tau] = \boldsymbol{\alpha} {\color{magenta}\boldsymbol{U}} \boldsymbol{e} \; \; \; \; \; \; \; \; \boldsymbol{U} = -\boldsymbol{S}^{-1}
$$
:::

::: {.absolute top="50%" left="10%" .larger}
$$\mathbb{E}[\tau^k] = k! \boldsymbol{\alpha} {\color{magenta}\boldsymbol{U}}^k \boldsymbol{e}$$
:::
...
::: {.absolute top="25%" left="10%" .larger }
$$F(t) = 1 - \boldsymbol{\alpha} {\color{magenta}e^{\boldsymbol{S}t}} \boldsymbol{e}, \quad t \geq 0$$
:::

::: {.absolute top="50%" left="10%" .larger}
$$f(t) = \boldsymbol{\alpha} {\color{magenta}e^{\boldsymbol{S}t}} (-\boldsymbol{S}) \boldsymbol{e}, \quad t \geq 0$$
:::
...
$$\mathbb{E}[Y^k] = k! \boldsymbol{\alpha} (\boldsymbol{U} \boldsymbol{\Delta}(\boldsymbol{r}))^k \boldsymbol{e}$$
...
$$F(t) = 1 - \boldsymbol{\pi} \boldsymbol{T}^t \boldsymbol{e}$$

Moments

The expectation:

$$\mathbb{E}[\tau] = \boldsymbol{\pi} \boldsymbol{U} \boldsymbol{e}$$
...
$$\text{Var}(\tau) = 2\boldsymbol{\alpha} \boldsymbol{U}^2 \boldsymbol{e} - (\boldsymbol{\alpha} \boldsymbol{U} \boldsymbol{e})^2$$
...
$$\text{Cov}(Y_i, Y_j) = \boldsymbol{\alpha}\boldsymbol{U}(\boldsymbol{R}_{\cdot i})\boldsymbol{U}(\boldsymbol{R}_{\cdot j})\boldsymbol{e} + \boldsymbol{\alpha}\boldsymbol{U}(\boldsymbol{R}_{\cdot j})\boldsymbol{U}(\boldsymbol{R}_{\cdot i})\boldsymbol{e} - \boldsymbol{\alpha}\boldsymbol{U}(\boldsymbol{R}_{\cdot i})\boldsymbol{e} \cdot \boldsymbol{\alpha}\boldsymbol{U}(\boldsymbol{R}_{\cdot j})\boldsymbol{e}$$
